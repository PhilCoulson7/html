...
setInterval(function() {
  ...
  // 人气值10修改图片，还要加上动画
  // js的逻辑判断
  // if(逻辑判断表达式){如果逻辑表达式为真，就会执行括号里的代码}
  // 数值相关的逻辑表达式 a < 10
  // <,>,<=,>=,== 分别对应意义：小于，大于，小于或等于，大于或者等于，相等
  if (rqz > 20000) {
    // js直接修改样式(style)的方法
  ...
  if (rqz > 100000) {
    img01.setAttribute('src', '001.jpg');
    img01.setAttribute('class', 'animated jackInTheBox');
    img02.setAttribute('src', '002.jpg');
...
// 元素.addEventListener  给元素添加处理事件，比如单击事件
